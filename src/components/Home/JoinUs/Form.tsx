...
const Form = () => {
  const { register, getValues, formState, clearErrors } = useForm<FormData>({
    mode: 'onBlur',
  });
  return (
    <form className="mx-auto mt-[36px] h-auto container font-raleway font-[18px] leading-[1.25] grid grid-cols-1 text-[#202328] xl:h-[310px]">
      {/* Email Input */}
          ...
          leftTypeIcon={
            ...
            >
              ...
              <defs>
                ...
                >
                  <stop stopColor="#15C5CE" />
                  <stop offset="0.96" stopColor="#0C677C" />
                </linearGradient>
                <linearGradient
