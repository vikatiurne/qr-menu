    ...
    <div className="grid xl:grid-cols-2 grid-cols-1 font-elMessiri text-center text-[#2B2A34] gap-[24px]">
      <div className="">
        ...
        <form className="mx-auto mt-[36px] h-auto container">
          <div className="font-raleway font-[18px] placeholder:text-[18px] leading-[1.25] grid grid-cols-1 gap-[34px] text-[#202328]  xl:h-[310px]">
            {/* Email Input */}
            <div className="relative">
              <div className="relative mt-2">
                <input
                  ...
                  name="email"
                  placeholder="E-mail"
                  className="w-full font-[18px] placeholder:text-[18px] pl-[38px] h-[52px] border border-[#15C5CE] rounded-[10px] focus:outline-none focus:ring-2 focus:ring-[#15C5CE] focus:border-transparent"
                  required
                />
                <span className="absolute inset-y-0 left-[14px] flex items-center">
                  <svg
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
            ...
            <div className="relative">
              <input
                ...
                className="w-full font-[18px] placeholder:text-[18px] xl:pl-[38px] xl:h-[52px] border border-[#15C5CE] rounded-[10px] focus:outline-none focus:ring-2 focus:ring-[#15C5CE] focus:border-transparent"
                required
              />
            ...
            <div className="relative">
              <input
                ...
                name="password"
                placeholder="Пароль"
                className="w-full font-[18px] placeholder:text-[18px] lg:pl-[38px] lg:h-[52px] border border-[#15C5CE] rounded-[10px] focus:outline-none focus:ring-2 focus:ring-[#15C5CE] focus:border-transparent"
                required
              />
              <span className="absolute inset-y-0 left-3 flex items-center">
                <svg
          ...
          <div className="w-full h-[54px] mt-[58px]">
          <CustomButton
            className="w-full h-full text-white text-[22px] font-elMessiri text-center font-bold leading-[29.7px] uppercase"
