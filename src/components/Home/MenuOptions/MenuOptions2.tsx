    ...
    <div>
      ...
      >
        ...
        <div className="absolute bottom-[24px]  flex gap-3 m-auto left-1/2 translate-x-[-50%]">
          {sliderData.map((item) => (
              <div className={`w-[14px] h-[14px] border-2  border-white rounded-full bg-transparent ${active === item.image && 'bg-[#11A1AE]'} `}>
      ...
      <div className="flex justify-between ">
        {sliderData.map((item) => (
          <CustomButton
            ...
            className={`border bg-gray-200 w-full min-h-[86px] leading-[19px] transition font-bold  rounded-b-[50px] ${item.image === active && 'text-white'}`}
