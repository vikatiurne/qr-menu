      ...
      <div className="container mx-auto min-w-[164px] xl:mb-[100px] sm:mb-[4em] mb-[3em] mobile:mb-[50px]">
        <div className="grid grid-cols-1 gap-[24px] xl:grid-cols-2">
          ...
          <div className="lg:row-span-2 flex justify-center items-center object-contain">
            <img
              className="h-full xl:w-full lg:w-[75%] sm:w-[85%] min-w-[164px] object-cover rounded-3xl mobile:rounded-[10px] mobile:h-[290px]"
              src={HeroCardImgRt}
              alt="cardImgRgt"
            />
          </div>
          ...
          <div className="flex flex-col justify-between items-center h-full">
            ...
            {/* 2 row - img+txt */}
            <div className="grid grid-cols-2 gap-[24px] xl:w-full lg:w-[75%]  mobile:w-[344px] mobile:gap-[16px] mx-auto">
              <img
